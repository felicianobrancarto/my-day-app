    ...
    <>
      <View style={estilostela4.Telaprincipal}>
        ...
        <View style={estilostela4.Caixa2}>
          ...
          <Cozinhar
            style={estilostela4.Iconecozinha}
            name="food-turkey"
            color={'white'}
            size={40}
          />
        ...
        <View style={estilostela4.Caixa3}>
          <Text style={estilostela4.Textocaixa3}>{itemSave.comentario}</Text>
        </View>
      </View>
    </>
  );
